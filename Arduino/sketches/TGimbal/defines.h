...
#define ACC_LPF_FACTOR 1   //magnitude of Acc data lowpass, filtering increases Acc lag
#define GYROWEIGHT 0.997      // weight of gyro in complementary filter, out of 1 
...
#define GYROSCALE ((2380 * PI)/((32767.0f / 4.0f ) * 180.0f * 1000000.0f))/4.0 //converts raw data units to radians, determined experimentally
#define GYROSCALE2 3.0/(56.6 * 1000000)
