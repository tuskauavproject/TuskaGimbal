...
#define ACC_LPF_FACTOR 60   //magnitude of Acc data lowpass, filtering increases Acc lag
...
#define GYROSCALE ((2380 * PI)/((32767.0f / 4.0f ) * 180.0f * 1000000.0f)) * 1 //converts raw data units to radians, determined experimentally
