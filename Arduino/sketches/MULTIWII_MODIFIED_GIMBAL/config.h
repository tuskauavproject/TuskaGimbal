...
/*************************************************************************************************/
  ...
  /***********************          Cam Stabilisation             ***********************/
    ...
    #define TILT_PITCH_PROP   17.5      //servo proportional (tied to angle) ; can be negative to invert movement
    #define TILT_ROLL_MIN     1050
    #define TILT_ROLL_MAX     1950
    #define TILT_ROLL_MIDDLE  1570
    #define TILT_ROLL_PROP    -17.5
...
/*************************************************************************************************/
  ...
  /********                          Failsave settings                 ********************/
    ...
    #define FAILSAVE_THROTTLE  (2000)    // Throttle level used for landing - may be relative to MINTHROTTLE - as in this case
